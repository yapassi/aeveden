...
<div class="container-fluid px-0 px-md-3 py-3">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3 gap-2">
        <div>
            ...
            <div>
            <a href="{{ route('admin.fiancailles.create') }}" class="btn btn-primary btn-sm">
                <i class="fas fa-plus me-1"></i> Nouveau couple
            </a>
        </div>
        </div>
    </div>
                        ...
                        <tr>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex align-items-center mb-2">
                                            <img src="{{ $fiance['fiance']->photo ? asset('storage/' . $fiance['fiance']->photo) : asset('images/default-male.png') }}" 
                                        ...
                                        <div class="d-flex align-items-center">
                                            <img src="{{ $fiance['fiancee']->photo ? asset('storage/' . $fiance['fiancee']->photo) : asset('images/default-female.png') }}" 
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="{{ route('admin.fiancailles.show', $fiance['id']) }}" 
                                       class="btn btn-sm btn-outline-primary px-2"
                                       title="Voir">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.fiancailles.edit', $fiance['id']) }}" 
