                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <div class="d-flex flex-column flex-md-row justify-content-end gap-2">
                            ...
                            <a href="{{ route('admin.rapports.index') }}" class="btn btn-outline-secondary">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="{{ route('admin.rapports.show', $rapport->id) }}" class="btn btn-sm btn-outline-primary" title="Voir">
                                    <i class="bi bi-eye"></i>
                                </a>
                            </div>
                        </td>
                ...
                <div class="d-flex justify-content-between align-items-start mb-3">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{ route('admin.rapports.show', $rapport->id) }}"><i class="bi bi-eye me-2"></i>Voir</a></li>
                        </ul>
                    </div>
                </div>
