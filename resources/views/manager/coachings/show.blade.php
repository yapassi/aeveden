...
<div class="container-fluid px-0">
    <!-- Bouton Retour -->
    <div class="px-3 py-2">
        <a href="{{ route('manager.coachings.index') }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card bg-light mb-3">
                    <div class="card-body">
                        <h6 class="fw-bold">Défis du couple</h6>
                        <p class="small mb-0">{{ $rapport->defis_couple ?: 'Aucun défi mentionné' }}</p>
                    </div>
                </div>
